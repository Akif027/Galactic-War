...
public class Target : MonoBehaviour
{
    ...
    {
        // Check if this is the owner of the PhotonView
      
           // view.RPC("TargetEnabled", RpcTarget.AllBuffered, true);
    ...
    private void OnDisable()
    {
        // Check if this is the owner of the PhotonView
          ...
          // view.RPC("TargetEnabled", RpcTarget.AllBuffered, false);
         OffScreenIndicator.TargetStateChanged.Invoke(this, false);
       
    }

 /* [PunRPC]
    private void TargetEnabled(bool enabled)
    {
        if (OffScreenIndicator.TargetStateChanged != null)
        {
            //Debug.Log("sdasdasdasdasdasdasdasdasdasd");
            OffScreenIndicator.TargetStateChanged.Invoke(this, enabled);
        }
    }*/
    /// <summary>
